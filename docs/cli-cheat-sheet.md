...
│
└─ input-validation
   ├─ run              [--host H | --endpoint ID | --parameter P] [--ignore-cache]
   ...
   ├─ show <param_name>
   ├─ export           [--output FILE]
   ├─ baseline         [--host H | --endpoint ID | --parameter P] [--force]
   ├─ identifier       [--host H | --endpoint ID | --parameter P] [--force]
   ├─ characters       [--host H | --endpoint ID | --parameter P] [--force]
   ├─ length           [--host H | --endpoint ID | --parameter P] [--force]
   ├─ types            [--host H | --endpoint ID | --parameter P] [--force]
   ├─ transformations  [--host H | --endpoint ID | --parameter P] [--force]
   ├─ reflection       [--host H | --endpoint ID | --parameter P] [--force]
   └─ validation       [--host H | --endpoint ID | --parameter P] [--force]
```
...
```bash
talos input-validation show <param_uuid>  # display full profile for a parameter (by UUID)
talos input-validation export             # export all IV intelligence as CSV (stdout)
talos input-validation export -o iv.csv   # export to file
```

Parameter UUIDs are visible in the UI (endpoint → parameter list) and in
`talos input-validation export` CSV output (`p.id` column).
