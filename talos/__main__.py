...
def _print_usage() -> None:
    print(
        ...
        "  intruder          High-volume mutation engine (Phase 1–3 CLI)\n"
        ...
        "                    example_values, pool; processors: encode/decode/hash/prefix/suffix…\n"
        "    strategy set    single | sniper | pitchfork | zip | cluster_bomb\n"
        "    timing set      fixed RPS (default 2), concurrency (default 1),\n"
        "                    optional --concurrency-per-host (Phase 2 host cap)\n"
        ...
        "    generators list Plugins inventory (generators/processors/strategies/storage)\n"
