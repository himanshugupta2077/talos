...
def _print_usage() -> None:
    print(
        ...
        "  endpoint   Manage endpoint annotations and policy\n"
        "               mark/unmark      — safety annotations (logout, dangerous)\n"
        "               show             — display policy, annotations, score breakdown\n"
        "               priority set/clear endpoint/path — manual priority overrides\n"
        "               exclude/include endpoint/path     — exclusion rules\n"
