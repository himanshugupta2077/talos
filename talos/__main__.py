...
def _print_usage() -> None:
    print(
        ...
        "  intruder          High-volume mutation engine (Phase 1+2 CLI)\n"
        ...
        "                    url_encode/decode, base64_encode/decode, to_lower/upper,\n"
        "                    html_encode/decode, md5/sha1/sha256, strip, prefix:/suffix:\n"
