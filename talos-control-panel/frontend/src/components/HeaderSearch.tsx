...
const JUMP_ITEMS: JumpItem[] = [
  ...
  { id: "access", label: "Access Model", path: "/access", group: "Model" },
  ...
  { id: "attack", label: "Attacks", path: "/attack", group: "Testing", keywords: "unauth bac" },
  { id: "iv", label: "Input Validation", path: "/input-validation", group: "Testing" },
