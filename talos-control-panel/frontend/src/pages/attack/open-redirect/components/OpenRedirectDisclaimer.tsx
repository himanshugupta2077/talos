export default function OpenRedirectDisclaimer() {
  return (
    <div className="alert alert-warning text-xs py-2 mb-4">
      <span>
        Open redirect / LFI testing sends outbound requests with mutated query,
        ...
        flow (visible in the Talos Burp extension under Open Redirect). Findings
